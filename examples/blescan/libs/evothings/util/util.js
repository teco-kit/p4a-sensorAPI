/*
Copyright 2015 Aaron Ardiri, Fredrik Eldh
 ...
 * Author: Aaron Ardiri, Fredrik Eldh
 */
...
evothings.util = (function()
{
    ...
    // Add the ability to load JSON file remotely.
    funs.loadJSON = function (callback) {

        var xobj = new XMLHttpRequest();
        //xobj.overrideMimeType("application/json");
        xobj.open('GET', 'json/bPart.json',true); // Replace 'my_data' with the path to your file
        xobj.onreadystatechange = function () {
            if (xobj.readyState == 4 && xobj.status == "200") {
                //hyper.log(xobj.status);
                // Required use of an anonymous callback as .open will NOT return a value but simply returns undefined in asynchronous mode
                callback(xobj.responseText);

            } else {
                //hyper.log("Could not get json file");
            }
        };
        xobj.send();
    }
